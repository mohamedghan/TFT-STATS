...
module.exports.run = async (bot, msg, args, config) => {
  if (args.length === 0) {
    ...
    const embed = {
      title: "COMMANDS",
      description: `to get help for a specific command use **${config.prefix}help [command name]** (this bot is still under development and a new feature will be added each day so stay tuned ♥) :`,
      color: 4886754,
      footer: {
